...
> 状态：D2 与 D3 已完成私有 Cloudflare Preview 验收；Goose adapter、组合模板和远端 `Pi -> Goose -> Pi`、D1/Workflow/取消/deadline/TTL 已通过受控 spike。Goose 浏览器选择仍关闭；跨 Run 用量聚合、Terminal 和 Preview 待完成。
